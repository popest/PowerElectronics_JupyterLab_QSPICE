#This file was autogenerated on 2024-09-03 23:23:15
import os
import subprocess


def QSPICE_Full_Wave_REC_P_load(Cf, ESR, freq, fwd, Pin, rdiff, VAC_rms):
    #### Create circuit file ####
    ...
    run_output = subprocess.run([exe_qspice64, "Full_Wave_REC_P_load.cir"])

    # Run postprocess measurement
    run_output = subprocess.run([exe_qpost, "Full_Wave_REC_P_load.cir", "-o", "results.txt"])

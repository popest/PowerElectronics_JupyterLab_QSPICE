#This file was autogenerated on 2025-01-22 23:41:39
import os
import subprocess
import pandas as pd
import re
    ...
    for i, line in enumerate(results_lines):
        ...
        match stripped_line:
            ...
            case ".meas i_sense_rms rms i(i_sense):": 
                results[18] = float(re.search(r'[-+]?\d*\.\d+|\d+', results_lines[i + 1])[0])

            case ".meas i_sense_avg avg i(i_sense):": 
                results[19] = float(re.search(r'[-+]?\d*\.\d+|\d+', results_lines[i + 1])[0])

#This file was autogenerated on 2024-12-22 12:40:05
import os
import subprocess
import pandas as pd
import re
...
def QSPICE_PSFB_center_tap(Coss, Cout_ESR, D, deadtime, eff, fsw_p, Iout_max, L_leak, Lout, Lp, Lr, N, Pmax, Rdiff, REC_fwd, Ron_MOS, Vin, Vout, export_traces = None):
    ...
    f.write(".meas I_Lsec1_RMS avg I(L2)" + "\n") # results[13]
    f.write(".meas I_Lsec2_AVG avg I(L3)" + "\n") # results[14]
    f.write(".meas I_Lsec2_RMS avg I(L3)" + "\n") # results[15]
    ...
    for i, line in enumerate(results_lines):
        ...
        match stripped_line:
            ...
            case ".meas i_lsec1_rms avg i(l2):": 
            ...
            case ".meas i_lsec2_rms avg i(l3):": 

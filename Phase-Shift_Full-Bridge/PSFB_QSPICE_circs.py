...
# This function generates QSPICE netlist with equivalent circuit of Phase-Shift Full Bridge Converter with full-bridge rectifier 
# It uses simplified diode models
...
def QSPICE_PFC_CCM_ACMC(VAC_rms, Cout, ESR, eff, fsw, freq, L, Pout, Vout):
    ...
    #### Generate cir File
    f = open("PSFB_CCM.cir", "w", newline='\n')

    #### Circuit Definition ###
    f.write("* Equivalent circuit of Phase-Shift Full Bridge Converter with full-bridge rectifier. Auto-Generated Netlist File"+"\n")
    f.write("Lprim N05 N06 {Lp}C"+"\n")
    f.write("Lsec N03 N02 {Ls}"+"\n")
    f.write("D5 N03 Vsec ideal"+"\n")
    f.write("D2 0 N03 ideal"+"\n")
    f.write("Lout N01 Vout {Lout}"+"\n") 

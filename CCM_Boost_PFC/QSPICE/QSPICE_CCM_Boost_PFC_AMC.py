#This file was autogenerated on 2025-02-27 22:45:47
import os
import subprocess
import pandas as pd
import re
...
def QSPICE_CCM_Boost_PFC_AMC(AC_freq, Cfp_I, Cfp_V, Cfz_I, Cfz_V, Cout, Cout_ESR, Dboost_fwd, Dboost_rdiff, eff, fsw, L, Pout, R_EMI, rdson, REC_fwd, REC_rdiff, Rf_I, Rf_V, Rsense, VAC_rms, Vout, export_traces = None):
    ...
    try:
        run_qspice64 = subprocess.run([exe_qspice64, "CCM_Boost_PFC_AMC.cir"], capture_output=True, text=True, check=True)
    ...
    try:
        run_qpost = subprocess.run([exe_qpost, "CCM_Boost_PFC_AMC.cir", "-o", "results.txt"], capture_output=True, text=True, check=True)
    except subprocess.CalledProcessError as e:
